...
<!DOCTYPE html>
 <html lang="en">
    <head>
        ...
        <meta name="og:site_name" content="BBN"/>
        <meta name="og:description" content="Web Panel for the Hadder Discord bot."/>
        <meta property="og:image" content="https://bbn.one/images/Hadder.png" />
        <meta property="og:url" content="https://hadder.bbn.one">
    ...
    <nav class="blue darken-2" role="navigation">
        <div class="nav-wrapper container">
            <img id="navbarIcon" src="https://bbn.one/images/Hadder.png" alt="Hadder">
            ...
            <ul id="navList" class="right hide-on-med-and-down">
                 <?php
                    if(isset($_SESSION['auth_token'])) {
                        ...
                        echo '<a href="' . url("637002314162372639", "http://hadder.bbn.one/auth/login.php", "identify guilds email connections") . '">' . '<i class="material-icons left">account_circle</i>Login with Discord</a></li>';
                    }
                ?>
            </ul>
        </div>
    ...
    <div id="wrapper">
        ...
        <section id="main">
            <header>
                <span class="avatar"><img src="https://bbn.one/images/avatar.png" width="260" height="270"/></span>
                <br>
                <h3>BBN</h3>
            </header>
            <br>
